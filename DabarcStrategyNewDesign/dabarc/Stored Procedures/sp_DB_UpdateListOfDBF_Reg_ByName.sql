CREATE PROCEDURE  [dabarc].[sp_DB_UpdateListOfDBF_Reg_ByName]
...
AS
	...
	--------------------------------------------------------------
	-- Agregamos la Base de Datos y lo registramos
	--------------------------------------------------------------
	...
	IF (ISNULL(@Int_Index,0) <> 0)
		EXECUTE sp_DB_UpdateListOfDBF_Reg @Int_Index, 1, @register_user
